...
export default {
  ...
  duckdb_create_logical_type: {
    parameters: ["i32"],              // duckdb_type (primitive type)
  ...
  duckdb_logical_type_set_alias: {
    parameters: [duckdb_logical_type, "pointer"], // duckdb_logical_type, const char* (alias)
    result: "void",                    // void
  },
  ...
  duckdb_create_list_type: {
    parameters: [duckdb_logical_type],           // duckdb_logical_type (child type)
    result: duckdb_logical_type,                 // duckdb_logical_type
  },
  ...
  duckdb_create_array_type: {
    parameters: [duckdb_logical_type, "u64"],    // duckdb_logical_type, idx_t (uint64_t)
    result: duckdb_logical_type,                 // duckdb_logical_type
  },
  ...
  duckdb_create_map_type: {
    parameters: [duckdb_logical_type, duckdb_logical_type],  // duckdb_logical_type (key type), duckdb_logical_type (value type)
    result: duckdb_logical_type,                 // duckdb_logical_type
  },
  ...
  duckdb_create_union_type: {
    parameters: ["pointer", "pointer", "u64"], // duckdb_logical_type*, const char**, idx_t (uint64_t)
    result: duckdb_logical_type,                         // duckdb_logical_type
  },
  ...
  duckdb_create_enum_type: {
    parameters: ["pointer", "u64"],    // const char** (member names), idx_t (uint64_t)
    result: duckdb_logical_type,                 // duckdb_logical_type
  },
  ...
  duckdb_create_decimal_type: {
    parameters: ["u8", "u8"],          // uint8_t (width), uint8_t (scale)
    result: duckdb_logical_type,                 // duckdb_logical_type
  },
  ...
  duckdb_struct_type_child_type: {
    parameters: [duckdb_logical_type, "u64"],    // duckdb_logical_type, idx_t (uint64_t)
    result: "pointer",                 // duckdb_logical_type
  },
