 ...
 *
 * Note: Basic streaming tests (multiple rows, single row, empty result, NULLs, types)
 * are covered in query.test.ts. This file focuses on stream-specific behaviors.
 */
